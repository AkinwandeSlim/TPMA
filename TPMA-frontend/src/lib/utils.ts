...
// Copy all your date utils (formatDateTime, convertDate, etc.) here
export const formatDateTime = (dateTimeString: string, timeZone: string = "Africa/Lagos") => {
  ...
  return new Intl.DateTimeFormat(undefined, options).format(dateTime);
};
// Add others...